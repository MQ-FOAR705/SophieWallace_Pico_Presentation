...
Tropy_Demo.png}
 ...
 \textbf{Image 1:} Automator workflow that exports images from the Mac Photos application and embeds metadata. The action 'Run Shell Script' adds the name of the researcher, the original date and time the photo was taken and prompts the user to write the location where the photos were taken. 
\vspace{8pt}
